...
<html lang="es">
    <head>
        <title>FRANZ ALEXANDER LARA AREVALO</title>
                ...
                <div class="row allign-items-center h-100">
                    ...
                    <div class="col">
                        <div class="allign-items-center">
                            <p>Franz Alexander Lara Arévalo</p>
                                            ...
                                            <td>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <small id="txt_user_help" class="form-text text_muted">El usuario es oblogatorio</small>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="txt_password">CONTRASEÑA</label>
                                                        <input type="password" class="form-control" name="txt_password" id="txt_password" maxlenght="15" aria-describedby="txt_password" required />
